...
class ReleaseService {
  constructor(options) {
    const { githubToken, githubReleaseEnabled, githubDraft, githubPrerelease, projectRoot, beekeeperUri, beekeeperEnabled, spinner } = options
    console.log({ githubReleaseEnabled })
    ...
    this.githubService = new GithubService({ githubReleaseEnabled, githubToken, githubDraft, githubPrerelease, spinner })
